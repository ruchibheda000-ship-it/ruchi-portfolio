...
export default function Home() {
  ...
  // State to trigger the physical spine-hinging opening animation
  ...
  return (
    <div className="min-h-screen bg-[#061840] text-[#F1E3CC] font-body selection:bg-[#E4BA83] selection:text-[#061840] relative overflow-x-hidden pb-24">
      ...
      {/* Replay Opening Animation Control (Floating subtle trigger) */}
      <div className="max-w-4xl lg:max-w-5xl mx-auto px-6 flex justify-end mb-2">
        <button
        ...
        >
          <span>↻</span>
          <span>Replay Diary Opening (Hinged Spine)</span>
        </button>
      </div>
      ...
      {/* ========================================================================= */}
      <div className="relative z-20 w-full max-w-4xl lg:max-w-5xl mx-auto px-3 sm:px-6 my-4 sm:my-8 diary-spine-anchor">
        ...
        {/* ----------------------------------------------------------------------- */}
        {/* UPPER HALF: BLUE COVER + PAGE 1 (Hinges open upwards around the spine) */}
        {/* ----------------------------------------------------------------------- */}
        <div
