      ...
      <main className="relative z-10 w-full max-w-6xl mx-auto px-6 sm:px-12 lg:px-20 py-8 sm:py-16 flex-grow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="bg-[#0B3272]/20 p-6 sm:p-8 rounded-lg border border-[#0B3272] shadow-sm">
              ...
              <div className="space-y-3 font-sans text-sm sm:text-base">
                <button
                  ...
                  className="w-full flex items-center gap-3 p-3.5 rounded-md border border-[#0B3272] bg-[#030d24] hover:border-[#E4BA83]/40 transition-colors cursor-pointer text-left"
                >
                  <span className={`w-5 h-5 rounded border border-[#0B3272] flex items-center justify-center font-mono text-xs ${checkedItems.opt1 ? 'bg-[#E4BA83] text-[#030d24] border-[#E4BA83]' : 'bg-transparent'}`}>
                    {checkedItems.opt1 ? '✓' : ''}
                  </span>
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 p-3.5 rounded-md border border-[#0B3272] bg-[#030d24] hover:border-[#E4BA83]/40 transition-colors cursor-pointer text-left"
                >
                  <span className={`w-5 h-5 rounded border border-[#0B3272] flex items-center justify-center font-mono text-xs ${checkedItems.opt2 ? 'bg-[#E4BA83] text-[#030d24] border-[#E4BA83]' : 'bg-transparent'}`}>
                    {checkedItems.opt2 ? '✓' : ''}
                  </span>
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 p-3.5 rounded-md border border-[#0B3272] bg-[#030d24] hover:border-[#E4BA83]/40 transition-colors cursor-pointer text-left"
                >
                  <span className={`w-5 h-5 rounded border border-[#0B3272] flex items-center justify-center font-mono text-xs ${checkedItems.opt3 ? 'bg-[#E4BA83] text-[#030d24] border-[#E4BA83]' : 'bg-transparent'}`}>
                    {checkedItems.opt3 ? '✓' : ''}
                  </span>
            ...
            <div className="p-6 sm:p-8 rounded-lg border border-[#0B3272] bg-[#0B3272] text-[#F1E3CC] shadow-md space-y-5">
              ...
              <div className="space-y-2.5 font-sans text-sm">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-between p-3 rounded hover:bg-[#030d24]/60 transition-colors"
                >
              ...
              <div className="pt-4 border-t border-[#030d24] text-[11px] font-mono text-[#8DA1B4]">
          ...
          <div className="lg:col-span-7">
            <div className="relative bg-[#0B3272]/20 text-[#F1E3CC] p-8 sm:p-12 rounded-lg border border-[#0B3272] shadow-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-md border border-[#0B3272] bg-[#030d24] text-[#F1E3CC] placeholder-[#8DA1B4]/50 text-sm focus:outline-hidden focus:border-[#E4BA83] transition-colors"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-md border border-[#0B3272] bg-[#030d24] text-[#F1E3CC] text-sm focus:outline-hidden focus:border-[#E4BA83] transition-colors cursor-pointer"
                    >
                      <option value="" className="bg-[#030d24] text-[#8DA1B4]">Select scope...</option>
                      <option value="full-time" className="bg-[#030d24] text-[#F1E3CC]">Full-time Product Designer Role</option>
                      <option value="design-system" className="bg-[#030d24] text-[#F1E3CC]">Design System & Complex UX</option>
                      <option value="mobile-web" className="bg-[#030d24] text-[#F1E3CC]">0-to-1 Web / Mobile App</option>
                      <option value="wayfinding" className="bg-[#030d24] text-[#F1E3CC]">Spatial & Environmental Wayfinding</option>
                      <option value="say-hi" className="bg-[#030d24] text-[#F1E3CC]">Casual Coffee / Say Hello</option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-md border border-[#0B3272] bg-[#030d24] text-[#F1E3CC] placeholder-[#8DA1B4]/50 text-sm focus:outline-hidden focus:border-[#E4BA83] transition-colors resize-none"
                    />
                  </div>

                  <button
                    type="submit"
                    className="w-full py-4 rounded-full bg-[#0B3272] text-[#F1E3CC] font-medium text-sm border border-[#0B3272] hover:bg-[#E4BA83] hover:text-[#030d24] hover:border-[#E4BA83] transition-colors cursor-pointer flex items-center justify-center gap-2"
                  >
